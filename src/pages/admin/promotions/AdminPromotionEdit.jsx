...
export default function AdminPromotionEdit() {
  ...
  useEffect(() => {
    async function fetchPromo() {
      try {
        ...
        const promo = data.promoCode || data.data || data;
        setForm({
          code: promo.code || '',
          type: promo.type || 'percentage',
          discount: promo.discount !== undefined ? String(promo.discount) : '',
          min_order_amount: promo.min_order_amount !== undefined && promo.min_order_amount !== null
          ...
          expiry_date: promo.expiry_date
            ? new Date(promo.expiry_date).toISOString().slice(0, 10)
            : '',
  ...
  if (serverError && !form) {
    return (
      <div className="p-6">
        ...
        <Link to="/admin/promotions" className="mt-4 inline-block text-indigo-600 hover:underline text-sm">
          ← Back to Promo Codes
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit Promo Code</h1>
